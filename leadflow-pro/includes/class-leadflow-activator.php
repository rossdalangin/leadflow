...
class LeadFlow_Activator {
	...
	public static function activate() {
		...
		if ( ! wp_next_scheduled( 'leadflow_process_auto_discovery' ) ) {
			wp_schedule_event( time(), 'daily', 'leadflow_process_auto_discovery' );
		}
		...
		if ( ! wp_next_scheduled( 'leadflow_check_usage' ) ) {
			wp_schedule_event( time(), 'daily', 'leadflow_check_usage' );
		}
	}
}
