	...
	<div class="wizard-container chart-box" style="max-width: 700px; margin: 60px auto; padding: 50px;">
		...
		<div class="wizard-steps">
			...
			<div class="wizard-step active" data-step="1">
				...
				<p>Enter your license key to unlock unlimited leads and sequences.</p>
				<input type="text" id="wizardLicenseKey" placeholder="LF-XXXX-XXXX-XXXX" class="regular-text" style="width:100%; margin-bottom:20px;">
